...
Source1:        mono.snk
Patch0:         mono-5.8.0-ignore-reference-assemblies.patch
Patch1:         mono-4.2.1-ppc.patch
Patch2:         mono-5.8.0-find-provides.patch
...
find . -name "*.dll" -not -path "./mcs/class/lib/monolite-linux/*" -print -delete
...
%changelog
* Thu Mar 08 2018 Timotheus Pokorra <tp@tbits.net> - 5.8.0-1
- update to 5.8.0.129, Release 15.6
