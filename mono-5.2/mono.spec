...
Source1:        mono.snk
Patch0:         mono-5.4.1-ignore-reference-assemblies.patch
Patch1:         mono-4.2.1-ppc.patch
Patch2:         mono-5.4.1-find-provides.patch
...
%changelog
* Fri Mar 02 2018 Timotheus Pokorra <tp@tbits.net> - 5.10.0-1
- update to 5.10.0.140
